...
def get_file_by_date_type(
    ...
    date_split = [_to_date(s) for s in date_split_str]
...
def B23_DesignChanges():
    ...
    B23_basic_doc_file = get_file_for_DesignChanges("B23精装", "docx")
    # B23_basic_doc_file = get_file_for_DesignChanges("B23燃气", "docx")
    CNCC2_DesignChanges(
        "./2025-01-02_B23合图-CNCC2_DesignChanges.xlsx",
        "./2022-01-28后_B23设计变更审批表.docx",
        "B23",
        "./B23/",
    )
...
def B24_DesignChanges():
    ...
    print(B24_xlsx_with_dir)
    B24_basic_doc_file = "./2024-05-09_B24设计变更审批表.docx"
    # print(f"B24_basic_doc_file = {B24_basic_doc_file}")
    CNCC2_DesignChanges(B24_xlsx_with_dir, B24_basic_doc_file, "B24", "./B24/")
