...
class base_data_from_xls:
    ...
    def __init__(self, file_name: str):
        ...
        self.base_data_no_proc.columns = [
            "审批表编号",
            "提出单位一",
            "变更原因二",
            "变更内容三",
    ...
    @staticmethod
    def set_major_cols(x: "DataFrame") -> str:
        """根据变更前缀编号确定何种专业
    ...
    def get_data_proceed(self) -> "Dataframe":
        """直接处理输入excel：
...
class replace_doc_lines:
    ...
    def __init__(self, basic_doc_file: str, doc_dir: str):
    ...
    def make_new_docx(self, num: int) -> None:
        ...
        self.proceed_doc_file = (
            ...
            + self.basic_doc_file.replace("_0_", file_num).split("\\")[-1]
        )
...
def copy_file_to_target(
    src_dir: str, file_key_name: str, des_dir: str
) -> True or False:
...
def copy_folder_to_target(
    src_dir: str, folder_key_name: str, des_dir: str
) -> True or False:
